 ...
 */
 /* mods 
 * 28jul16 zig - remove meta data from single (showing on testimonials when click continue Reading)
 */
get_header();
			...
			<main class="col-xs-12<?php echo 'left' === $sidebar ? '  col-md-9  col-md-push-3' : ''; echo 'right' === $sidebar ? '  col-md-9' : ''; ?>" role="main">
				...
				<article <?php post_class( 'post-inner' ); ?>>
					...
					<div class="meta-data">
						...
						<?php /* zig xout <span class="meta-data__author"><?php _e( 'By' , 'buildpress_wp'); ?> <?php the_author(); ?></span>
					...
					<?php
						...
						wp_link_pages( $args );
					?>
					<?php /* zig xout comments_template( '', true ); */ ?>
				</article>
